...
'
'------------------------------------------------------------------------
' Код при регистрации получается путём преобразования символов
' имени пользователя в десятичный эквивалент и преобразованием
' в символьную строку с отсечением 12 символов слева. Пример:
' Nik Tupkalov (781051073284......) - остальные не надо.
'-------------------------------------------------------------------------
'
